...
export default function MobileMenu({ isOpen, onClose, isActive }: MobileMenuProps) {
  ...
  // ✅ Render above everything, not inside header stacking context
